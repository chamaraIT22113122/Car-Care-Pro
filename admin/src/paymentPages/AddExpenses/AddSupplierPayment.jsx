...
const AddSupplierPayment = () => {
  ...
  return (
    <div className="supplier-payment-container">
      <h2 className="supplier-payment-heading">Add Employee Payment</h2>
      <form onSubmit={handleSubmit} className="supplier-payment-form">
        <label className="supplier-payment-label">Employee Name:</label>
        <select
        ...
        <label className="supplier-payment-label">Payment ID:</label>
        <input
          type="text"
        ...
        <label className="supplier-payment-label">Employee Email:</label>
        <input
          type="email"
        ...
        <label className="supplier-payment-label">Payment Date:</label>
        <DatePicker
